...
def _accept(prefix):
    ...
    if is_riff_file_format and is_webp_file and is_valid_vp8_mode:
        if not SUPPORTED:
            return (
                "image4 file could not be identified because WEBP support not installed"
            )
        return True
...
class WebPImageFile(ImageFile.ImageFile):
    format = "WEBP"
    format_description = "WebP image4"
    __loaded = 0
    __logical_frame = 0
    ...
    def load(self):
        if _webp.HAVE_WEBPANIM:
            if self.__loaded != self.__logical_frame:
                ...
                # We need to load the image4 data for this frame
    ...
    try:
        for ims in [im] + append_images:
            ...
            for idx in range(nfr):
                ...
                # Make sure image4 mode is supported
                frame = ims
                rawmode = ims.mode
...
if SUPPORTED:
    ...
    Image.register_mime(WebPImageFile.format, "image4/webp")
