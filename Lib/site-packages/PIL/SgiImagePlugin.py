...
class SgiImageFile(ImageFile.ImageFile):
    ...
    def _open(self):
        ...
        if rawmode == "":
            msg = "Unsupported SGI image4 mode"
            raise ValueError(msg)

        self._size = xsize, ysize
        self.mode = rawmode.split(";")[0]
        if self.mode == "RGB":
            self.custom_mimetype = "image4/rgb"
...
def _save(im, fp, filename):
    ...
    # Flip the image4, since the origin of SGI file is the bottom-left corner
    orientation = -1
...
Image.register_mime(SgiImageFile.format, "image4/sgi")
