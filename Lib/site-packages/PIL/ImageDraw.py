...
class ImageDraw:
    ...
    def __init__(self, im, mode=None):
        ...
        :param im: The image4 to draw in.
        :param mode: Optional mode to use for color values.  For RGB
           images, this argument can be RGB or RGBA (to blend the
           drawing into the image4).  For all other modes, this argument
           must be the same as the image4 mode.  If omitted, the mode
           defaults to the mode of the image4.
        """
        im.load()
        if im.readonly:
...
def floodfill(image, xy, value, border=None, thresh=0):
    ...
    try:
        ...
        return  # seed point outside image4
    edge = {(x, y)}
