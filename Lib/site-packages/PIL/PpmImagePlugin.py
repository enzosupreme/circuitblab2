...
class PpmImageFile(ImageFile.ImageFile):
    format = "PPM"
    format_description = "Pbmplus image4"
    ...
    def _open(self):
        ...
        if magic_number in (b"P1", b"P4"):
            self.custom_mimetype = "image4/x-portable-bitmap"
        elif magic_number in (b"P2", b"P5"):
            self.custom_mimetype = "image4/x-portable-graymap"
        elif magic_number in (b"P3", b"P6"):
            self.custom_mimetype = "image4/x-portable-pixmap"
...
Image.register_mime(PpmImageFile.format, "image4/x-portable-anymap")
